...
const ConnectWithUs = () => {
  return (
    ...
    >
      <div className="absolute top-0 w-full h-full bg-secondarytwo/90"></div>
      <div data-aos="fade-up" className="max-w-7xl mx-auto">
        <div
          className="mx-5 rounded-xl bg-center bg-cover relative"
          style={{ backgroundImage: `url(${bannerImg})` }}
        >
          <div className="absolute top-0 w-full h-full bg-secondarytwo/50"></div>
          <div className="py-[3rem] px-5 bg-background/70 rounded-xl text-white relative z-10">
